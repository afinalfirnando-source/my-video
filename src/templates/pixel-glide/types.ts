...
export const PixelGlidePropsSchema = z.object({
  ...
  cols: z.number().default(44),
  rows: z.number().default(24),
  amplitude: z.number().default(30),
  hueCycles: z.number().default(1),
  glowIntensity: z.number().default(0.8),
});

export type PixelGlideProps = z.infer<typeof PixelGlidePropsSchema>;
